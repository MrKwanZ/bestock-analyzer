...
A LangChain + LangGraph agent that automatically identifies the best-performing NASDAQ stock of the day, analyses its recent performance, generates charts, and delivers a formatted report to any inbox.
...
<img src="outputs/bestock_graph.png" alt="BeStock Agent Architecture Graph" width="850">
...
|---|---|---|
| `OPENAI_API_KEY` | ✅ | OpenAI key for report, sentiment, and query-refinement chains |
| `OPENAI_MODEL` | optional | Model name (default: `gpt-4o-mini`) |
| `ALPHAVANTAGE_API_KEY` | ✅ | [Alpha Vantage](https://www.alphavantage.co/support/#api-key) free key |
...
| `DEFAULT_EMAIL_RECIPIENT` | ✅ | Fallback recipient when none is entered in the UI |
